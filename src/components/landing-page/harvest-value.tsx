...
//           {/* Add the overlay text if needed */}
//           <div className=" absolute bottom-0 left-0 right-0 bg-gradient-to-r from-[rgb(91,103,72)] to-[rgb(60,69,43)] p-[clamp(16px,3vw,30px)] rounded-b-[10px]">
//             <p className=" text-white text-[clamp(16px,2.5vw,20px)] font-medium">
//               A Community Driven Initiative for Inclusive Agricultural Growth
//             </p>
//           </div>
...
//         {/* Right section - Smaller images and stats */}
...
//                 </p>
//               </section>
//               <div className=" absolute bottom-0 right-0 bg-white rounded-tl-[14px] px-[14px] py-[12px] flex gap-[10px] items-center">
//                 <Button variant="secondary" size="nlgg" className="w-fit">
//                   See more
//                 </Button>
//                 <article className=" flex items-center justify-center p-[6px] border border-[#141414] rounded-[8px] w-[38px] h-[38px] bg-white">
