...
function Testimonial() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      name: "MoyinOluwa A,",
      title: "Processor",
      text: "FoodFlow Africa is a game changer! I love how easy it is to use and how it connects farmers directly to suppliers, logistics, and markets all in one place. It's practical, efficient, and exactly what the agricultural sector in Africa needs.",
      quoteImage: "quotes-border.png",
      bgColor: "bg-[#000]",
      textColor: "text-[#fff]",
      nameColor: "text-[#fff]",
