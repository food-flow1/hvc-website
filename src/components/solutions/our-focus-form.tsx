...
function OurFocusForm() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      const formGuid = "238901cf-20e8-4214-adb5-07e59ef7d0dc"; // Replace with your HubSpot form ID

      // HubSpot tracking cookie (optional but recommended)
      ...
      if (response.ok) {
        ...
        console.error("HubSpot error:", await response.json());
          ...
          <div className="rounded-[20px] p-6 mb-[clamp(16px,2vw,32px)] border border-[#EBEBEB] bg-white relative overflow-hidden">
            ...
            <div className="pt-2">
              ...
              <p className="text-[#141414] text-[16px] italic font-medium">
                Food Freedom by HVC delivers curated food essentials directly to
                your doorstep with flexibility and added bonuses tailored to fit
                your lifestyle. Fill out the interest form below to learn more
                about our subscription packages, referral rewards, and the
                bonuses we offer each month. Once you’ve registered your
                interest, our team will reach out to help you find the perfect
                plan.
              </p>
            </div>
          </div>
