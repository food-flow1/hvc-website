...
//     // Your portal ID and form GUID
//     const PORTAL_ID = "146841102";
//     const FORM_GUID = "75caa554-108f-49f1-8eef-f09f92b5adbd";
...
//     if (formData.interests.length === 0) {
//       console.log("Validation failed - no interests selected"); // Debug log
//       toast.info("Please select at least one area of interest.");
//       setIsSubmitting(false);
//       return;
//     }

//     if (!formData.contact_methods) {
//       console.log("Validation failed - no contact method selected"); // Debug log
...
//                     ? "bg-gray-400 cursor-not-allowed"
//                     : "bg-gradient-to-r from-[#008807] to-green-700 hover:from-green-700 hover:to-green-800 transform hover:scale-105"
//                 } text-white font-medium py-[9px] px-[29px] rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl w-fit disabled:opacity-50 disabled:cursor-not-allowed`}
//               >
//                 {isSubmitting ? "Submitting..." : "Submit"}
//               </button>
...
//               Farm Fuel Interest Form
//             </h2>
//             <p className="text-[#141414] text-[16px] italic font-medium mb-6">
//               FarmFuel by Harvest Value Chain Limited is more than just a
//               renewable energy solution—it's a partnership to transform
//               agricultural waste into power, income, and sustainable farming
//               solutions. Fill out the form below to indicate your interest,
...
//                 className="bg-gradient-to-r from-[#008807] to-green-700 hover:from-green-700 hover:to-green-800 transform hover:scale-105 text-white font-medium py-3 px-8 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl"
//               >
//                 Start Application
//               </button>
//             )}
...
//         {/* Google Form - Shows when button is clicked */}
//         {showForm && (
//           <div className="bg-white rounded-[20px] border border-[#EBEBEB] overflow-hidden">
//             <div className="p-4 bg-gradient-to-r from-[#9DC655] to-[#7BA83F]">
//               <h3 className="text-white font-semibold text-lg">
//                 Application Form
//               </h3>
//             </div>
//             <iframe
//               src="https://docs.google.com/forms/d/e/https://docs.google.com/forms/d/1PQ5ywPTQxjDgb_3DBXKTeRmxs0ApDRsYcttMlmJLycw/viewform?embedded=true"
//               width="100%"
//               height="1200"
//               frameBorder="0"
//               marginHeight={0}
...
//             </iframe>
//             {/* <iframe
//               src="https://docs.google.com/forms/d/e/1FAIpQLSfMwohfq3yeUG1VnIJ3NhanRGbyENeyBY6S7YOcLYY6uHu-ag/viewform?embedded=true"
//               width="640"
//               height="1764"
//               frameborder="0"
//               marginheight="0"
