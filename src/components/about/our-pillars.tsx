  ...
  const pillars = [
    {
      ...
      description:
        "At the heart of HVC are eco-friendly farms and ethical livestock operations that prioritize food security, soil health, and animal welfare.",
      image: "",
    },
    {
  ...
  return (
    <div className="px-[clamp(40px,4.1vw,80px)] py-[clamp(40px,4.1vw,80px)] items-center flex justify-center bg-white max-[768px]:px-[20px]">
      <section className=" flex flex-col gap-[24px]">
        <TagLayout
          tag="Our 4 pillars of operation"
          tagColour="#141414"
          subText="What we do"
          subTextColor="#141414"
        ...
        <div className="grid grid-cols-4 gap-[10px] max-[768px]:grid-cols-1 max-[768px]:gap-[10px]">
          {pillars.map((pillar, index) => (
            <section
              key={index}
              className={`relative px-[18px] py-[136px] flex h-[490px] bg-[#E1FCAD] flex-col gap-[14px] overflow-hidden transition-all duration-300 max-[768px]:h-[300px] max-[768px]:py-[40px] ${
            ...
            >
              ...
              <figure
                className={`relative z-10 w-[60px] h-[50px] transition-all duration-300 ${
                  index === 0 ? "" : "lg:group-hover:hidden"
                }`}
              >
              ...
              <section className=" flex flex-col items-center">
                <div
                  className={`relative z-10 flex gap-2 flex-col ${
                    index === 0 ? "" : "lg:group-hover:hidden"
                  }`}
                >
